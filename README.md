...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTk5MjQzOTMwOmI4Mzk2ZTYxNzY2ZGMzNzJlMTU3MTljNTA2MTk0MjAzNmU3MWI5N2E1MTcwMmJhNDRiODEwYWQ5NzcxYzVjMzg=--2a3f17e6f577ea2f24b6b599a9a9a17d9889a3e6">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C785:73F4:1421FF9:235DEAC:59A9B1B1" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="C785:73F4:1421FF9:235DEAC:59A9B1B1" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="30845192" name="octolytics-actor-id" /><meta content="ecs515" name="octolytics-actor-login" /><meta content="dbeb1e3e7350d35517157ad2cf4ffe498ffe9426830fb677ca2fca8b57f60aae" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="ecs515">
  ...
  <meta name="html-safe-nonce" content="66aaed68ad069df7a75f9ea9ae91c3067943fd26">
  ...
  <meta name="description" content="sw-sdk-visual-delphi - SW SmarterWeb Client Library for Visual Delphi">
  <meta name="go-import" content="github.com/lunasoft/sw-sdk-visual-delphi git https://github.com/lunasoft/sw-sdk-visual-delphi.git">

  <meta content="6212462" name="octolytics-dimension-user_id" /><meta content="lunasoft" name="octolytics-dimension-user_login" /><meta content="91361641" name="octolytics-dimension-repository_id" /><meta content="lunasoft/sw-sdk-visual-delphi" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="91361641" name="octolytics-dimension-repository_network_root_id" /><meta content="lunasoft/sw-sdk-visual-delphi" name="octolytics-dimension-repository_network_root_nwo" /><meta content="true" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<header class="Header  f5" role="banner">
  <div class="d-flex px-3 flex-justify-between container-lg">
    <div class="d-flex flex-justify-between">
      <a class="header-logo-invertocat" href="https://github.com/orgs/lunasoft/dashboard" data-hotkey="g d" aria-label="Homepage" data-ga-click="Header, go to dashboard, icon:logo">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lunasoft/sw-sdk-visual-delphi/search" class="js-site-search-form" data-scoped-search-url="/lunasoft/sw-sdk-visual-delphi/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/lunasoft/sw-sdk-visual-delphi/blob/0.0.3.1/README.md" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="lunasoft/sw-sdk-visual-delphi">This repository</span>
  </div>
    <a class="dropdown-item" href="/lunasoft/sw-sdk-visual-delphi/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name"
        ...
        <img alt="@ecs515" class="avatar" src="https://avatars2.githubusercontent.com/u/30845192?v=4&amp;s=40" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">ecs515</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/ecs515" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/ecs515?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kgqQhfEzk5p0o9u42NaDU6nCzMVh6ZBAF2z6Jhuo9YTa7ZgvfhCElLT2tG2WLeLesrw3s9Mk6jRp5T0xpGG5zQ==" /></div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="lT6MwZyfa44ZL8h2y4yPXGqAxI7Mz5dYeFIV97+AwoDH9ayv/LQURDyQHDMYf1cITwW7LduEWRipVwy5Z1KXEQ==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="91361641" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/lunasoft/sw-sdk-visual-delphi/subscription"
            ...
            <a class="social-count js-social-count"
              href="/lunasoft/sw-sdk-visual-delphi/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lunasoft/sw-sdk-visual-delphi/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2FND88GKtBqZ9Y1hswq1302WoYSY2iOPCOZMB+jKYwhexY5fVtVIGJwxjMCzPwRSCqJakY1egdfa91WDKs1auA==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar lunasoft/sw-sdk-visual-delphi"
        data-ga-click="Repository, click unstar button, action:blob#show; text:Unstar">
        <svg aria-hidden="true" class="octicon octicon-star" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/></svg>
        Unstar
      </button>
        <a class="social-count js-social-count" href="/lunasoft/sw-sdk-visual-delphi/stargazers"
           aria-label="0 users starred this repository">
          0
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lunasoft/sw-sdk-visual-delphi/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="z2EWFVpKezuxQ8kc2ln/gNQ01zjb5Vlv5H4DsNU2qzWVM48DcGDo3AOxKmkAFI2ca+CsiMrLE5MtlYawH30nZA==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star lunasoft/sw-sdk-visual-delphi"
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              title="Fork your own copy of lunasoft/sw-sdk-visual-delphi to your account"
              aria-label="Fork your own copy of lunasoft/sw-sdk-visual-delphi to your account"
              rel="facebox"
    ...
    <a href="/lunasoft/sw-sdk-visual-delphi/network" class="social-count"
  ...
  <span class="author" itemprop="author"><a href="/lunasoft" class="url fn" rel="author">lunasoft</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/lunasoft/sw-sdk-visual-delphi" data-pjax="#js-repo-pjax-container">sw-sdk-visual-delphi</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/lunasoft/sw-sdk-visual-delphi/tree/0.0.3.1" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /lunasoft/sw-sdk-visual-delphi/tree/0.0.3.1" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/lunasoft/sw-sdk-visual-delphi/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /lunasoft/sw-sdk-visual-delphi/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/lunasoft/sw-sdk-visual-delphi/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /lunasoft/sw-sdk-visual-delphi/pulls" itemprop="url">
    ...
    <a href="/lunasoft/sw-sdk-visual-delphi/projects" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /lunasoft/sw-sdk-visual-delphi/projects">
      <svg aria-hidden="true" class="octicon octicon-project" height="16" version="1.1" viewBox="0 0 15 16" width="15"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a href="/lunasoft/sw-sdk-visual-delphi/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /lunasoft/sw-sdk-visual-delphi/wiki">
      <svg aria-hidden="true" class="octicon octicon-book" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>
      <a href="/lunasoft/sw-sdk-visual-delphi/settings" class="js-selected-navigation-item reponav-item" data-selected-links="repo_settings repo_branch_settings hooks integration_installations /lunasoft/sw-sdk-visual-delphi/settings">
    ...
    <div class="reponav-dropdown js-menu-container">
      ...
      <div class="dropdown-menu-content js-menu-content">
        <div class="dropdown-menu dropdown-menu-sw">
            <a class="dropdown-item" href="/lunasoft/sw-sdk-visual-delphi/community" data-skip-pjax>
          ...
          <a class="dropdown-item" href="/lunasoft/sw-sdk-visual-delphi/pulse" data-skip-pjax>
            <svg aria-hidden="true" class="octicon octicon-pulse" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"/></svg>
            Pulse
          </a>
          <a class="dropdown-item" href="/lunasoft/sw-sdk-visual-delphi/graphs" data-skip-pjax>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/lunasoft/sw-sdk-visual-delphi/blob/9b9deaa4d69b0f06973432f46af9b5e6e9436b65/README.md" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:9f07dae2e6fb89489d310bfcb267e9d4 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/lunasoft/sw-sdk-visual-delphi/blob/0.0.3.1/README.md"
               data-name="0.0.3.1"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/lunasoft/sw-sdk-visual-delphi/blob/develop/README.md"
               data-name="develop"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/lunasoft/sw-sdk-visual-delphi/blob/master/README.md"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/lunasoft/sw-sdk-visual-delphi/tree/v0.0.2.1/README.md"
              data-name="v0.0.2.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="BtnGroup float-right">
      <a href="/lunasoft/sw-sdk-visual-delphi/find/0.0.3.1"
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/lunasoft/sw-sdk-visual-delphi/tree/0.0.3.1"><span>sw-sdk-visual-delphi</span></a></span></span><span class="separator">/</span><strong class="final-path">README.md</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/lunasoft/sw-sdk-visual-delphi/commit/ca0721bc4466a90b62bf6e38ffe8cb71a6cabb05" data-pjax>
          ca0721b
        </a>
        <relative-time datetime="2017-08-31T22:17:05Z">Aug 31, 2017</relative-time>
      </span>
      <div>
        <img alt="@ecs515" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/30845192?v=4&amp;s=40" width="20" />
        <a href="/ecs515" class="user-mention" rel="contributor">ecs515</a>
          <a href="/lunasoft/sw-sdk-visual-delphi/commit/ca0721bc4466a90b62bf6e38ffe8cb71a6cabb05" class="message" data-pjax="true" title="Libreria nativa en delphi, incluye ejemplos de uso y readme">Libreria nativa en delphi, incluye ejemplos de uso y readme</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>2</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="alxcodes" href="/lunasoft/sw-sdk-visual-delphi/commits/0.0.3.1/README.md?author=alxcodes"><img alt="@alxcodes" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/23086346?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ecs515" href="/lunasoft/sw-sdk-visual-delphi/commits/0.0.3.1/README.md?author=ecs515"><img alt="@ecs515" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/30845192?v=4&amp;s=40" width="20" /> </a>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/lunasoft/sw-sdk-visual-delphi/raw/0.0.3.1/README.md" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/lunasoft/sw-sdk-visual-delphi/blame/0.0.3.1/README.md" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/lunasoft/sw-sdk-visual-delphi/commits/0.0.3.1/README.md" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
...
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/lunasoft/sw-sdk-visual-delphi/delete/0.0.3.1/README.md" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kIadayvwODIO+hLx7lceafnTelPWX/1m5J5FDJoqGHKEbFyOtrYI0FN23FDMYCtjiuc2A9zd4j9tjJSVDR9TkQ==" /></div>
